...
export default function Login() {
  ...
  return (
    <div className="container" style={{ width: '30%', height: '100vh', background: '#3c8dbc', padding: '30px', borderRadius: '20px' }}>
      <div className="cover-login">
        ...
        <div className="cover-input-login">
          ...
          <button className="form-control mt-5 btn-login-admin" onClick={() => { login() }}>ĐĂNG NHẬP</button>
        </div>
      </div>
    </div>
  )
